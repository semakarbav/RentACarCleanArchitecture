...
namespace Application.Features.Maintenances.Queries.GetMaintenanceList
{
    public class GetMaintenanceListQuery:IRequest<MaintenanceListModel>
    {
        ...
        public class GetMaintenanceLisctQueryHandler : IRequestHandler<GetMaintenanceListQuery, MaintenanceListModel>
        {
            IMaintenanceRepository _maintenanceRepository;
            IMapper _mapper;

            public GetMaintenanceLisctQueryHandler(IMaintenanceRepository maintenanceRepository, IMapper mapper)
            {
