        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FindexScore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FindexScore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FindexScore_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentCityId = table.Column<int>(type: "int", nullable: false),
                    ReturnCityId = table.Column<int>(type: "int", nullable: false),
                    ReturnedCityId = table.Column<int>(type: "int", nullable: true),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    RentedKilometer = table.Column<int>(type: "int", nullable: false),
                    ReturnedKilometer = table.Column<int>(type: "int", nullable: false),
                    CarId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "State", "CityId", "ColorId", "FindexScore", "Kilometer", "ModelId", "ModelYear", "Plate" },
                values: new object[] { 1, 1, 1, 1, 600, 0, 2, (short)2018, "06ABC06" });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "State", "CityId", "ColorId", "FindexScore", "Kilometer", "ModelId", "ModelYear", "Plate" },
                values: new object[] { 2, 1, 2, 2, 600, 0, 1, (short)2018, "34ABC34" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FindexScore_CustomerId",
                table: "FindexScore",
                column: "CustomerId");
